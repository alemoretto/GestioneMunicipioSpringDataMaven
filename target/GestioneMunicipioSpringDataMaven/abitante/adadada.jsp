...
<%-- 					<input type="hidden" name="municipioId" id="municipioId" value="${abitanteDTO.municipioInput}"> --%>
<!-- 				</div> -->
<!-- 			</div> -->
...
<!-- 					<button type="submit" class="btn btn-primary btn-md">Aggiorna i dati</button> -->
<!-- 				</div> -->
<!-- 			</div> -->
