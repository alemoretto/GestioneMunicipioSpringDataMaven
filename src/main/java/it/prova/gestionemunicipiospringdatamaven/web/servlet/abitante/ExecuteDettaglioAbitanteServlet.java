...
@WebServlet("/abitante/ExecuteDettaglioAbitanteServlet")
public class ExecuteDettaglioAbitanteServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		Abitante abitanteDaVisualizzare = abitanteService
				.caricaSingoloAbitanteEager(Long.parseLong(request.getParameter("idAbitante")));
		AbitanteDTO abitanteDTO = AbitanteDTO.buildAbitanteDTOInstance(abitanteDaVisualizzare);

		request.setAttribute("abitanteDTO", abitanteDTO);
		request.getRequestDispatcher("/abitante/dettaglioAbitante.jsp").forward(request, response);
	}
